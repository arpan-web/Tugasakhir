            ...
            <form action="{{ route('pasien.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex mt-2">
                            <div class="form-check me-4">
                                <input class="form-check-input" type="radio" name="status_pasien" id="statusPolnep" value="Polnep" {{ old('status_pasien') == 'Polnep' ? 'checked' : '' }} required>
                                <label class="form-check-label" for="statusPolnep">Sivitas Polnep</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status_pasien" id="statusUmum" value="Umum" {{ old('status_pasien') == 'Umum' ? 'checked' : '' }} required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nomor_kartu_pasien" name="nomor_kartu_pasien" value="{{ old('nomor_kartu_pasien') }}">
                    </div>
